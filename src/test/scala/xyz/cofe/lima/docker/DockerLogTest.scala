...
import xyz.cofe.lima.docker.log.JsonLogEventReader
...
class DockerLogTest extends AnyFunSuite {
  ...
  test("read fail entry") {
    implicit val reader = JsonLogEventReader.reader
    val entry = logEntry_Fail.jsonAs[LogEvent[_,_]]
  ...
  val logEntry_Succ = """{
                        ...
                        |  },
                        |  "beginTime": "2022-11-05T23:47:45.419213947",
                        |  "endTime": "2022-11-05T23:47:45.815995118",
                        |  "args": {
                        |    "_type": "Containers",
                        |    "all": true,
                        |    "size": false
                        ...
                        |        "Networks": {
                        |          "bridge": {
                        |            "NetworkID": "4a955ecc7b049d87122c26ae1e2aba68a380876cbdf022ebc1f57d52f7a4323c",
                        |            "EndpointID": "",
                        |            "Gateway": "",
                        |            "IPAddress": "",
                        |            "IPPrefixLen": 0,
